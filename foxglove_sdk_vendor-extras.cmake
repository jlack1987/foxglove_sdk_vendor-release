...
set(_foxglove_sdk_vendor_library "${_foxglove_sdk_vendor_prefix}/lib/libfoxglove.a")

if(NOT TARGET foxglove_sdk_vendor::foxglove_sdk)
  if(NOT EXISTS "${_foxglove_sdk_vendor_library}")
    message(FATAL_ERROR
      "foxglove_sdk_vendor expected to find libfoxglove.a at '${_foxglove_sdk_vendor_library}'")
  endif()

  add_library(foxglove_sdk_vendor::foxglove_sdk STATIC IMPORTED)
